...
Le fichier \verb|pdf| contenant toutes les maquettes se trouve dans 
\verb|no_code/mocks/serado.pdf|. Le voici:

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{../mocks/serado.pdf}
