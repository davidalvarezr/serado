  ...
  partners = [
    {
      ...
      desc:
        '1ère plateforme gratuite de mise en relation entre employeur privé et employé(e) de maison.<br><br> Vous recherchez un ou ' +
    ...
    },
    {
      ...
      desc:
        'Vous souhaitez acquérir et/ou renforcer vos ' +
